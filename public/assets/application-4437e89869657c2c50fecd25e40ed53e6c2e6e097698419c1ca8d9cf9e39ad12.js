...
(function() {
  ...
  Dashing.Forecast = (function(superClass) {
...
(function() {
  ...
  Dashing.News = (function(superClass) {
    ...
    News.prototype.onData = function(data) {
      return this.currentIndex = 0;
    };

    News.prototype.startCarousel = function() {
      return setInterval(this.nextComment, 8000);
    };

    News.prototype.nextComment = function() {
      var headlines;
